              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-4 p-4 rounded-lg bg-muted/50 border border-border/50">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Get expert advice at no cost</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4 p-4 rounded-lg bg-muted/50 border border-border/50">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Tailored plans for your unique needs</p>
                  </div>
                </div>
              </div>
            </div>
